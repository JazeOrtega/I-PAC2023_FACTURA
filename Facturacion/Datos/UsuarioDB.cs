...
namespace Datos
{
    public class UsuarioDB
    {
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        if (dr.Read())
                        {
                            ...
                            user.fechaInicio = Convert.ToDateTime(dr["FechaCreacion"]);
        ...
        public bool Insertar(Usuario user)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append(" INSET INTO usuario VALUES ");
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        comando.Parameters.Add("@FechaCreacion", MySqlDbType.DateTime).Value = user.fechaInicio;
        ...
        public bool Edito(Usuario user)
        {
            bool edito = false;
            try
            {
        ...
        public bool Eliminar(string codigoUsuario)
        {
            ...
            try
            {
                ...
                sql.Append(" WHERE CodigoUsuario=@CodigoUsiario");
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    _conexion.Open();
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
